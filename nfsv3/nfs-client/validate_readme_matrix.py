...
This script is intended to run inside the nfsv3-nfs-client container as root.
...
def main() -> int:
    ...
    parser.add_argument("--readme", default="/workspace/nfsv3/README.md", help="Path to README with matrix table")
    ...
    if os.geteuid() != 0:
        print("ERROR: run this script as root inside nfsv3-nfs-client container.")
        return 2
