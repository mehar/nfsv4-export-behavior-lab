...
NFS_SERVERS="${NFS_SERVERS:-root_squash=nfsv3-nfs-server-root-squash,all_squash_ubuntu=nfsv3-nfs-server-all-squash-ubuntu,all_squash_redhat=nfsv3-nfs-server-all-squash-redhat,all_squash_windows=nfsv3-nfs-server-all-squash-windows,no_root_squash=nfsv3-nfs-server-no-root-squash}"
MOUNT_BASE="${MOUNT_BASE:-/mnt/nfs}"
NFS_EXPORT_BASE="${NFS_EXPORT_BASE:-/exports}"
MOUNT_OPTS="${MOUNT_OPTS:-vers=3,nolock,soft,timeo=50,retrans=2}"
